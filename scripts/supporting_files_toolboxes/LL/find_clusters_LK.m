...
if ~exist('label', 'var') || isempty(label)
    fileID = fopen('/isilon/LFMI/VMdrive/Lua/MEG_alpha_1-f_SCP/supporting_files_toolboxes/CTF275labels.txt');
...
if ~exist('neighbors', 'var') || isempty(neighbors)
     load('/isilon/LFMI/VMdrive/Lua/MEG_alpha_1-f_SCP/supporting_files_toolboxes/ctf275_neighb.mat');
...
if plot_option == 1
    ...
    dat = make_ft_struct(datfortopo, 'timelock',si);
